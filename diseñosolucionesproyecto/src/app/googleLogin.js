...
const toggleAdminFormButton = document.getElementById('toggleAdminForm');
const adminForm = document.getElementById('adminForm');

toggleAdminFormButton.addEventListener('click', () => {
  adminForm.style.display = 'block'; // Mostrar formulario de administrador
});